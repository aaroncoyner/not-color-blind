...
train_data_random_labels <- train_data %>%
    sample_frac() %>%
    mutate(random_label = c(rep(0, floor(nrow(train_data) / 2)), rep(1, ceiling(nrow(train_data) / 2))))
...
dir_create('./out/datasets/retcam/train/black')
dir_create('./out/datasets/retcam/train/white')
dir_create('./out/datasets/retcam/train_random/0')
dir_create('./out/datasets/retcam/train_random/1')
dir_create('./out/datasets/retcam/val/black')
dir_create('./out/datasets/retcam/val/white')
dir_create('./out/datasets/retcam/test/black')
dir_create('./out/datasets/retcam/test/white')

dir_create('./out/datasets/segmentations/train/black')
dir_create('./out/datasets/segmentations/train/white')
dir_create('./out/datasets/segmentations/train_random/0')
dir_create('./out/datasets/segmentations/train_random/1')
dir_create('./out/datasets/segmentations/val/black')
dir_create('./out/datasets/segmentations/val/white')
dir_create('./out/datasets/segmentations/test/black')
dir_create('./out/datasets/segmentations/test/white')
...
file_copy(paste(src, train_data_random_labels$fundus_location, sep = '/'),
          paste(dst, train_data_random_labels$random_label, train_data_random_labels$fundus_location, sep = '/'),
          overwrite = TRUE)
...
file_copy(paste(src, train_data_random_labels$segmentation_location, sep = '/'),
          paste(dst, train_data_random_labels$random_label, train_data_random_labels$segmentation_location, sep = '/'),
          overwrite = TRUE)
